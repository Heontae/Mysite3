				...
				<div id="modifyForm">
					<form action="${pageContext.request.contextPath}/reply/modify" method="get">
						...
						<div class="form-group">
							...
							<span class="form-value">${ReplyVo.name }</span>
						</div>
						...
						<div class="form-group">
							...
							<span class="form-value">${ReplyVo.reg_date }</span>
						</div>
						...
						<a id="btn_cancel" href="${pageContext.request.contextPath}/reply/list">취소</a>
