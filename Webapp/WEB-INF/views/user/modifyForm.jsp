					...
					<form action="${pageContext.request.contextPath}/user/modify"
						...
						<div class="form-group">
							<label class="form-text" for="input-pass">패스워드</label> <input
								type="password" id="input-pass" name="password" value="${userVo.password }"
						...
						<div class="form-group">
							<label class="form-text" for="input-name">이름</label> <input
								type="text" id="input-name" name="name" value="${session.name }"
						...
						<div class="form-group">
							<span class="form-text">성별</span>
								...
								<c:if test="${userVo.gender.equals('male') }">
								...
								<c:if test="${userVo.gender.equals('female') }">
									<label for="rdo-male">남</label>
									<input type="radio" id="rdo-male" name="gender" value="male">
									<label for="rdo-female">여</label>
									<input type="radio" id="rdo-female" name="gender"
